...
//       } transition-all  z-10 border border-1 max-w-[300px] w-full rounded-tr-xl  rounded-br-xl shadow-sm`}
//     >
//       <header
//         onClick={() => setIsSidebarExpanded(!isSidebarExpanded)}
//         className='flex  bg-red-300 h-full cursor-pointer pl-7 justify-start'
//       >
//         <div className='flex gap-4 self-start items-center h-full'>
